...
public class AddIncome extends AppCompatActivity {
    ...
    public void submit(View view) {
        ...
        DatabaseHelper db = new DatabaseHelper(AddIncome.this);
        String incomeId = Utils.generateUniqueId();
        long rowID = db.insertIncome(incomeId, amount, date);

        if (rowID != -1) {
            showIncomeAddedDialog();
        } else {
            Toast.makeText(AddIncome.this, "Failed to add income. Try again.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showIncomeAddedDialog() {
        ...
        tvMessage.setText("Entry recorded successfully!");
